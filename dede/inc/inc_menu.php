...
<m:top item='3_' name='留言管理' display='none' rank='co_NewRule,co_ListNote,co_ViewNote,co_Switch,co_GetOut'>
  <m:item name='在线留言管理' link='diy_list.php?action=list&diyid=1' rank='co_ListNote' target='main' />
